...
const buttonVariants = tv({
	...
	variants: {
		variant: {
			...
			ghost: [
				`[--btn-color-bg:transparent] [--btn-color-edge-bright:transparent] [--btn-color-edge-dark:transparent]`,
				`[--btn-color-text:var(--btn-color-text-on-neutral)]`,
				'[--btn-has-shadow:0]',
				'hover:([--btn-color-bg:var(--color-neutral)] translate-y-none)',
			],
		},
		size: {
			xs: `px-1.75 py-0.5 text-xs/5 [--btn-roundedness:var(--roundedness-sm)]`,
			sm: `px-2 py-0.75 text-xs/6`,
			base: `px-4 py-1.25 text-sm/6`,
		...
		'3d': {
			true: [
				...
				`after:(transition-transform absolute -translate-z-2px translate-y-4px top-0 left-0 content-[''] rounded-[--btn-roundedness] w-full h-full [background-color:rgb(0_0_0_/_calc(0.3*var(--btn-has-shadow)))] filter-blur-1px)`,
			...
			false: [
				...
				`after:(transition-transform absolute -translate-z-2px translate-y-1px top-0 left-0 content-[''] rounded-[--btn-roundedness] w-full h-full [background-color:rgb(0_0_0_/_calc(0.3*var(--btn-has-shadow)))] filter-blur-[calc(1px*var(--btn-has-shadow))])`,
